...
export default function Page() {
  ...
  if (isError) {
    return <div className="dark:bg-[#0A0A0C] dark:text-white">Error: {error.message}</div>;
  }
    ...
    <div className="min-h-screen max-w-7xl mx-auto dark:bg-[#0A0A0C] dark:text-white ">
      <div id="Main">
        <div className="mt-14 sm:mt-10 pt-14 relative z-10 rounded-xl ">
          ...
          {/* audio player */}
          <div className="w-full mx-auto px-6  bg-white transition-all duration-500 dark:bg-[#0A0A0C] dark:text-white dark-mode">
            <audio
              controls
              volume
              ref={audioRef}
