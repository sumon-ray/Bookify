...
export default function Page() {
  ...
  const { data: mybooks, isLoading: myBooksLoading, refetch: myBooksRefetch } = useQuery({
    queryKey: ['my books', giveSearch, session?.user?.email],
    queryFn: async () => {
    ...
    <div className="max-w-7xl mx-auto md:pt-20 ">
      ...
      {/* Modal  of Give Books*/}
      {
        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center p-4 bg-black bg-opacity-50 z-50">
          <div className="bg-[#F3F2ED]  rounded-lg shadow-lg w-full max-w-[800px] min-h-[50vh] relative pb-14">

            <div className="text-xl text-center font-black p-3 bg-[white] rounded-t-lg">
              <h1>
            ...
            <div className="p-6">
                    ...
                    <div className="flex items-center justify-between pb-8 pt-2">
                      <div>
                        <div className=" relative w-40 lg:w-72 md:w-52 ">
                          <input
                            className="bg-[white] w-full border-0 focus:ring-[#EFEEE9] focus:outline-none focus:ring rounded-md py-2 px-4 pr-14"
                            type="text"
                            placeholder="Search..."
                            onChange={handleGiveSearch} />
                          <div className="absolute right-0 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
                            <div className={`bg-[#364957]   p-2 rounded-bl-3xl rounded-md rounded-tl-none cursor-pointer ${'' ? "" : ""}`}>
                              {false ? (
                                <Lottie
                                  animationData={''}
                      ...
                      myBooksLoading
                        ...
                        : <div className="max-h-[350px] relative overflow-y-scroll">
                          <table className="w-full leading-normal">
                            <thead>
                              <tr className="sticky top-0 w-full font-bold bg-[white]">
                              ...
                              {mybooks?.map((book) => (
                                <tr key={book?._id} className="border-b border-black">
                                  ...
                                  <td className="px-5 py-5">
                                    <p className=" text-black whitespace-no-wrap">{book?.title}</p>
                                  </td>
                                  <td className="px-5 py-5">
                                    <p className=" text-black whitespace-no-wrap">{book?.owner}</p>
                                  </td>
                                  <td className="px-5 py-5">
                                    <div>
                                      <button onClick={() => giveBooksExchange(book)} className="relative inline-block font-medium text-white px-3 py-1 bg-[#36495799] rounded-md">
              ...
              <button onClick={() => { 
                ...
                className="mt-4 text-white bg-[#364957] px-4 py-2 rounded absolute bottom-4">
                Close
              </button>
            </div>
          ...
          <div className="bg-[#F3F2ED]  rounded-lg shadow-lg w-full max-w-[800px] min-h-[50vh] relative pb-14">
            ...
            <div className="p-6">
                      ...
                      <tbody>
                        {usersBooks?.map((book) => (
                          <tr key={book?._id} className="border-b border-black">
                            ...
                            <td className="px-5 py-5">
                              <div>
                                <button onClick={() => takeBookExchange(book)} className="relative inline-block font-medium text-white px-3 py-1 bg-[#36495799] rounded-md">
                                  <span className="flex items-center gap-x-0.5"> <TbExchange />Exchange </span>
                                </button>
                              </div>
                            </td>
              ...
              <button  onClick={() => {
                ...
                className="mt-2 text-white bg-[#364957] px-4 py-2 rounded absolute bottom-4">
                Close
              </button>
