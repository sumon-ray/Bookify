  ...
  return (
    <div className="max-w-7xl mx-auto md:pt-20 ">
      ...
      <div className="flex lg:gap-14 flex-col md:flex-row px-4">
        ...
        {/* Take Books */}
        <div className="lg:w-[50%] md:h-[500px] w-full bg-[#EFEEE9] dark:bg-[#0A0A0CCC] dark:text-white rounded-lg md:p-6">
            ...
            <div className="p-6">
              {
                !mybooks?.length && !giveSearch?.length
                  ? <div className="flex flex-col items-center">
                    ...
                    <button className="flex items-center justify-between gap-x-4 mt-2 text-white text-sm font-bold  bg-[#364957] dark:bg-[#0A0A0C] rounded-lg p-2 focus:ring-[#ffffff] focus:outline-none focus:ring focus:border-[#ffffff]">
                      Add Book
                      <span>
                          ...
                          <div className="absolute right-0 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
                            <div className={`bg-[#364957] dark:bg-white  p-2 rounded-bl-3xl rounded-md rounded-tl-none cursor-pointer ${'' ? "" : ""}`}>
                              {false ? (
                                ...
                                <MdOutlineKeyboardVoice className="text-2xl text-white dark:text-black" />
                              )}
                            </div>
                          </div>
                        </div>
                      ...
                      myBooksLoading
                        ...
                        : <div className="max-h-[350px] relative overflow-y-scroll dark:text-white">
                          <table className="w-full leading-normal">
                            ...
                            <tbody>
                              {mybooks?.map((book) => (
                                <tr key={book?._id} className="border-b border-black dark:border-white dark:text-white">
              ...
              <div className="flex items-center justify-between pb-8 pt-2">
                <div>
                  <div className=" relative w-40 lg:w-72 md:w-52 ">
                    ...
                    <div className="absolute right-0 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
                      <div
                        className={`bg-[#364957] dark:bg-white  p-2 rounded-bl-3xl rounded-md rounded-tl-none cursor-pointer ${'' ? "" : ""
                          }`}
                      // onClick={''}
                      >
                        {false ? (
                ...
                usersBooksLoading
                  ...
                  : <div className="max-h-[350px] relative overflow-y-scroll">
                    <table className="w-full leading-normal">
                      ...
                      <tbody>
                        {usersBooks?.map((book) => (
                          <tr key={book?._id} className="border-b border-black dark:border-white">
                            <td className="px-5 py-5  text-sm">
                              <div>
                                <Image
                                  unoptimized
