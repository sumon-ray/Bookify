...
export default function Page() {
  ...
  const { data: usersBooks, isLoading: usersBooksLoading, refetch: usersDataRefetch } = useQuery({
    ...
    queryFn: async () => {
      const res = await axios(`https://bookify-server-lilac.vercel.app/books?excludeEmail=${session?.user?.email}&owner=${selectedOwner}`)
      const data = res.data
      return data;
    },
    enabled: !!user
    ...
    <div className="max-w-7xl mx-auto md:pt-20 ">
      ...
      {/* Modal  of Give Books*/}
      {
        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center p-4 bg-black bg-opacity-50 z-50">
          <div className="bg-[#F3F2ED]  rounded-lg shadow-lg w-full max-w-[800px]">
            ...
            <div className="p-6">
              ...
              <button onClick={() => { setGiveBooksModal(false) }}
                className="mt-4 text-white bg-[#364957] px-4 py-2 rounded">
                Close
              </button>
            </div>
        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center p-4 bg-black bg-opacity-50 z-50">
          <div className="bg-[#F3F2ED]  rounded-lg shadow-lg w-full max-w-[800px]">
            ...
            <div className="p-6">
              ...
              <button onClick={() => { setTakeBooksModal(false) }}
                className="mt-4 text-white bg-[#364957] px-4 py-2 rounded">
                Close
              </button>
