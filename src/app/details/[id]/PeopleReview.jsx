        ...
        <div>
            <div className="p-6 space-y-2">
                <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-4 md:flex-row">
                    <img src={data?.profile} alt="" className="self-center flex-shrink-0 w-14 h-14 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-300" />
