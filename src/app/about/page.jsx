        ...
        <div className="grid  md:grid-cols-2 gap-9 px-6 md:px-0">
          ...
          <div className="flex items-center justify-center w-full px-6 py-8 lg:h-[32rem] ">
            <div className="max-w-xl space-y-1">
              ...
              <p className="pb-3 text-balance">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem
                nihil ratione eveniet magnam, corporis qui tempore numquam totam
                mollitia asperiores dolor laborum saepe eum reiciendis. Non vel
                praesentium inventore blanditiis?
              </p>
              <button className="bg-[#A85D32] text-white p-2 font-bold rounded-lg">
                Our Service
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center w-full px-6 py-8 lg:h-[32rem] ">
            <div className="max-w-xl text-right">
              <h3 className="text-2xl font-serif font-bold text-balance">
                Which book has had the biggest impact on your life? Share your
                story in the comments.
              </h3>
              <p className="pt-3 pb-5 text-balance">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Quaerat doloremque possimus culpa dolorem incidunt expedita
                architecto, nulla quos deleniti dolor vel aspernatur earum
                temporibus id ad molestiae. Neque, et vel?
              </p>
              <button className="bg-[#A85D32] text-white p-2 font-bold rounded-lg">
                Our Project
              </button>
