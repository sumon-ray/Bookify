    ...
    const handleSendMessage = () => {
        if (message.trim()) {
            ...
            const messageInfo = {
                ...
                messageText: message ,
                timestamp: new Date() // Automatically sets the current date and time
              };
                       ...
                       {/* Message Head */}
                        <div className="bg-[#364957] p-4 text-white flex justify-between items-center">
                            ...
                            <div className="relative inline-block text-left">
                                <button button onClick={() => setMsgModal(!msgModal)} id="setting" className=" rounded-md p-1">
                                   <ImCross/>
                                </button>
                        ...
                        <div className="flex flex-col flex-grow h-0 p-4 overflow-auto">
                            {messages.map((msg, index) => (
                                <div key={index} className={`flex w-full mt-2 space-x-3 max-w-xs ${msg.isSender ? 'ml-auto justify-end' : ''}`}>
                                    ...
                                    <div>
                                        <div className={`p-3 rounded-lg ${msg.isSender ? 'bg-blue-600 text-white rounded-l-lg rounded-br-lg' : 'bg-gray-300 text-start rounded-r-lg rounded-bl-lg'}`}>
