            ...
            <div className='flex flex-col-reverse lg:flex-row gap-7'>
                ...
                <div className='hidden lg:block md:w-[22%] space-y-3'>
                    ...
                    <div className='space-y-2.5'>
                        ...
                        <select required onChange={handleAuthor} className='w-[270px] bg-[#EFEEE9]  border-0 rounded-md focus:ring-[#ffffff] focus:outline-none focus:ring focus:border-[#ffffff] dark:bg-[#0A0A0C] dark:text-white'>
                            <option value="volvo" selected disabled>Author</option>
                            <option value="">All</option>
                            {uniqueAuthor?.map((author, i) => <option key={i} value={author}>{author}</option>)}
                        </select>

                        <select required onChange={handlePublisher} className='w-[270px] bg-[#EFEEE9] border-0 rounded-md focus:ring-[#ffffff] focus:outline-none focus:ring focus:border-[#ffffff] dark:bg-[#0A0A0C] dark:text-white'>
                        ...
                        <select required onChange={handlePublishYear} className='w-[270px] bg-[#EFEEE9] border-0 rounded-md focus:ring-[#ffffff] focus:outline-none focus:ring focus:border-[#ffffff] dark:bg-[#0A0A0C] dark:text-white'>
                            <option value="volvo" selected disabled>Publish Year</option>
                            <option value="">All</option>
                            {uniqueYear?.map((Year, i) => <option key={i} value={Year}>{Year}</option>)}
                        </select>

                        <select required onChange={handleLanguage} className='w-[270px] bg-[#EFEEE9] border-0 rounded-md focus:ring-[#ffffff] focus:outline-none focus:ring focus:border-[#ffffff] dark:bg-[#0A0A0C] dark:text-white'>
                        ...
                        {/* check box */}
                        <div>
                            <ul className="text-sm font-medium rounded-md bg-[#EFEEE9] dark:bg-[#0A0A0C] dark:text-white p-1 pb-1.5">
                                    ...
                                    <div>
                                        {
                                            uniqueGenre?.slice(0, 6).map((book, i) => <li className="w-full" key={i}>
                                                <div className="flex items-center ps-3">
                                                    <input type="checkbox" value={book} name='checkbox' className="w-4 h-4 text-[#364957] bg-white rounded focus:ring-[#364957] dark:bg-[#0A0A0C66] dark:text-black" />
                        ...
                        {/* price range taker */}
                        <div className='bg-[#EFEEE9] dark:bg-[#0A0A0C] dark:text-white rounded-md p-4 py-2 space-y-1'>
                            <h3 className='font-medium'>Price Range</h3>
                            <div className='flex justify-center text-[#364957] dark:text-white'>
                                <Box sx={{ width: 225 }} >
                                    <Slider
                                        getAriaLabel={() => 'Range'}
                                        value={value}
            ...
            <div className='flex flex-col md:flex-row items-center justify-center md:justify-between  pt-3.5 md:pt-3 gap-y-2 px-0 md:px-4 lg:px-0'>
                ...
                <Stack spacing={0}>
                    <Pagination
                        ...
                        className='text-white css-yyypgg-MuiButtonBase-root-MuiPaginationItem-root.Mui-selected'
                        sx={{
