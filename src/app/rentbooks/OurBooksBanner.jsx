...
export default function OurBooksBanner() {
  return (
    <div style={{ backgroundImage: "url('./bg3.jpg')" , backgroundAttachment: "fixed"}} className="w-full min-h-[70vh] bg-cover ">
      <div className="bg-gradient-to-tr from-[#000000CC] to-[#00000033] min-h-[70vh] *:text-white flex flex-col justify-center items-center text-center space-y-4">
