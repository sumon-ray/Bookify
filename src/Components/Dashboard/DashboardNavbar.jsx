                ...
                <div className="flex items-center gap-2 md:gap-4"> {/* Adjusted gap for smaller screens */}
                  ...
                  <div className="relative">
                    <div>
                      ...
                      <p className="absolute top-0 -mt-1 right-0 bg-[#364957] text-white rounded-full text-sm  px-[5px]">{notificationSeen ? notification.length + notificationApprove.length : <></>}</p>
                    </div>
                    <Menu
