...
const PremiumBoard = () => {
  return (
    <div className="mt-20 bg-gradient-to-r from-[#4a6a79] via-[#5b7f8f] to-[#364957] rounded-lg text-white text-center pb-2 space-y-2 absolute shadow-lg">
      ...
      <button className="bg-white text-black font-semibold px-2 py-1 rounded-full shadow-md hover:bg-gray-200 transition-all duration-300">
        Get Pro
      </button>
    </div>
  );
